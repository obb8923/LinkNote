        ...
        {relations.length > 0 && (
          <>
            ...
            <View className="flex-row items-center mb-2" style={{ height: 18 }}>
              ...
              <Text text={t('personDetail.relationSection')} type="body3" className="text-neutral-600 font-semibold mr-8" style={{ lineHeight: Platform.OS === 'ios' ? 18 : 18 }} />
              <TouchableOpacity onPress={handleAddRelation}>
                <Text text={t('people.actions.addRelation')} type="body3" className="text-primary font-semibold underline" style={{ lineHeight: Platform.OS === 'ios' ? 18 : 18 }} />
              </TouchableOpacity>
            </View>
            <View className="flex-1">
